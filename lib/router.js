Router.configure({
    ...
    waitOn: function() { return Meteor.subscribe("posts"); } // What we are saying here is that for every route on the site (we only have one right now, but soon we’ll have more!), we want to subscribe to the posts subscription.
});
